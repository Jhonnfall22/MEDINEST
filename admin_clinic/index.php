...
<body>
    ...
    <!--! [Start] Clinic Admin Header Right !-->
    <div class="d-flex align-items-center">

        <!--! [Clinic Admin] Global Search Dropdown !-->
        ...
        <!--! [Clinic Admin] Fullscreen Toggle !-->


        <!--! [Clinic Admin] Dark / Light Mode Switch !-->
        ...
        <!--! [Clinic Admin] Notifications Dropdown !-->
        ...
        <!--! [Clinic Admin] User Profile Dropdown !-->
       
    </div>
    <!--! [End] Clinic Admin Header Right !-->
</div>
        ...
        <div class="nxl-content">
            ...
            <div class="main-content">
                <div class="row">
                    ...
                    <div class="col-xxl-8">
                        <div class="card stretch stretch-full">
                            <div class="card-header">
                                <h5 class="card-title">Status Record</h5>
                    ...
                    <!-- [Total Sales] end !-->
                    <!-- [Mini] start -->
                    <!-- ================= Clinic Admin Task Overview ================= -->

<!-- [Clinic Admin] Tasks Completed -->
<div class="col-lg-4">
        ...
        <div class="card-header d-flex align-items-center justify-content-between">
            <div class="d-flex gap-3 align-items-center">
                ...
                <div>
                    ...
                    <!-- clinic appointments, treatments, follow-ups -->
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: [
            { title: 'Appointment', start: '2026-01-18T10:00:00' },
            { title: 'Treatment', start: '2026-01-20' },
            { title: 'Follow-up', start: '2026-01-22T14:30:00' }
        ]
    });
        ...
        <div class="card-header d-flex align-items-center justify-content-between">
            <div class="d-flex gap-3 align-items-center">
                ...
                <div>
                    ...
                    <!-- completed clinic projects (campaigns, system updates, programs) -->
                </div>
            </div>
        </div>
...
<div class="col-xxl-4">
    <div class="card stretch stretch-full">
        ...
        <div class="card-body custom-card-action">
            <!-- Donut chart showing clinic leads distribution -->
            <div id="leads-overview-donut"></div>

            <div class="row g-2 mt-3">
                <!-- Example lead categories with color codes -->
                ...
                <!-- Add more lead categories here -->
                <!-- e.g., New Clients, Follow-ups, Walk-ins -->
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-footer">
            <ul class="list-unstyled d-flex align-items-center gap-2 mb-0 pagination-common-style">
                ...
                <li><a href="javascript:void(0);"><i class="bi bi-arrow-right"></i></a></li>
                   ...
                   <!-- ================= Clinic Admin – Upcoming Schedule ================= -->
<div class="col-xxl-4">
    <div class="card stretch stretch-full">
        <div class="card-header">
        ...
        <div class="card-body">
            ...
            <div class="p-3 border border-dashed rounded-3 mb-3">
                <div class="d-flex justify-content-between">
                    <div class="img-group lh-0 ms-3 justify-content-start d-none d-sm-flex">
                        ...
                        <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                            <img src="assets/images/avatar/5.png" class="img-fluid" alt="Marianne Audrey" />
                        </a>
                        <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                            <img src="assets/images/avatar/6.png" class="img-fluid" alt="Marianne Audrey" />
                        </a>
            ...
            <!-- Additional event boxes can be added here -->

        </div>

        <a href="javascript:void(0);" class="card-footer fs-11 fw-bold text-uppercase text-center py-4">Upcoming Schedule</a>
    </div>
</div>
