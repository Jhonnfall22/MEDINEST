...
<body>
    ...
    <h4>User Management – Vet Clinic</h4>
    ...
    <form>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="position" onchange="showFields()">
        ...
        <!-- Admin Fields -->
        <div id="adminFields" class="role-fields d-none">
            <div class="mb-3">
        ...
        <!-- Veterinarian Fields -->
        <div id="vetFields" class="role-fields d-none">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="e.g. Small Animals">
            </div>
        </div>

        <!-- Receptionist Fields -->
        <div id="receptionistFields" class="role-fields d-none">
            <div class="mb-3">
                <label class="form-label">Shift Schedule</label>
                <input type="text" class="form-control" placeholder="e.g. Morning / Evening">
            </div>
        </div>

        <!-- Assistant Fields -->
        <div id="assistantFields" class="role-fields d-none">
            <div class="mb-3">
...
<script>
    function showFields() {
        ...
        } else if (position === 'vet') {
            document.getElementById('vetFields').classList.remove('d-none');
        } else if (position === 'receptionist') {
            document.getElementById('receptionistFields').classList.remove('d-none');
        } else if (position === 'assistant') {
            document.getElementById('assistantFields').classList.remove('d-none');
        }
    }
</script>
